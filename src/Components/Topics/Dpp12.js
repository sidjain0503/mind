...
import physics11 from '../Homepage/data/dpps/physics12.json'
import maths11 from '../Homepage/data/dpps/maths12.json'
import physical11 from '../Homepage/data/dpps/physical12.json'
import organic11 from '../Homepage/data/dpps/organic12.json'
import inorganic11 from '../Homepage/data/dpps/inorganic12.json'
   ...
   const scroll =()=>{
    ...
    return (
        < div className='freeresource-container'>
            ...
            <h1 style={{ fontFamily: "Manrope", fontSize: "30px", width: "75%", margin: "auto" }}>Find Below the Dpps of class 12 </h1>
