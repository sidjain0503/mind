...
import chemistry from '../Homepage/data/mindmaps/chemistry1.json'
import physics from '../Homepage/data/mindmaps/physics1.json'
import maths from '../Homepage/data/mindmaps/maths1.json'
   ...
   const scroll =()=>{
    ...
    return (
        < div className=''>
            ...
            <h1 style={{ fontFamily: "Manrope", fontSize: "30px", width: "75%", margin: "30px auto" }}>Find Below the Dpps of class 12 </h1>
